...
const blogCommentLikeRouter = require('./routers/blog-route/blog-comment-like.route');
const blogCommentRouter = require('./routers/blog-route/blog-comment.route');
const blogLikeRouter = require('./routers/blog-route/blog-like.route');
const blogViewRouter = require('./routers/blog-route/blog-view.route');
const blogBookmarkRouter = require('./routers/blog-route/blog-bookmark.route');
...
app.use(blogViewRouter);
app.use(blogCommentRouter);
app.use(blogCommentLikeRouter);
app.use(blogBookmarkRouter);
