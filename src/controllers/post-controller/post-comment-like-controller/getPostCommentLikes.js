...
const getPostCommentLikes = async (req, res) => {
  try {
    const query = [
      {
        $match: {
    ...
    const postCommentLikes = await PostCommentLike.aggregate([
      ...query,
      {
        $lookup: {
          from: 'userprofiles',
    ...
    responseHandler(postCommentLikes, 200, req, res);
  } catch (e) {
    errorHandler(e, 400, req, res);
  }
};

module.exports = getPostCommentLikes;
