...
const getPostReplyCommentLikes = async (req, res) => {
  try {
    const query = [
      {
        $match: {
    ...
    const postReplyCommentLikes = await PostReplyCommentLike.aggregate([
      ...query,
      {
        $lookup: {
          from: 'userprofiles',
    ...
    responseHandler(postReplyCommentLikes, 200, req, res);
  } catch (e) {
    errorHandler(e, 400, req, res);
  }
};

module.exports = getPostReplyCommentLikes;
